...
export async function getForeCastWeathe_byCityName(cityName: string){
    try {
...
export async function getForeCastWeathe_byLatLon(lat: string, lon: string){
    try {
        const response = await fetch(
...
export async function getCurrenttWeather_byCityName(cityName: string){
    try {
        const response = await fetch(
...
export async function getCurrenttWeather_byLatLon(lat: string, lon: string){
    try {
        const response = await fetch(
